...
for key in APP_KEY APP_ENV APP_DEBUG APP_URL ACTIVE_THEME DB_CONNECTION DB_DATABASE LOG_CHANNEL CACHE_STORE SESSION_DRIVER LINK_POLICY RELATIVE_LINKS; do
    patch_env "$key"
done
